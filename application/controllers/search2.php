...
class Search2 extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->view('search/search2', $data);
    ...
    public function tree_list()
    {
        ...
        $this->load->view('header/header2');
        $this->load->view('dashboard/list_of_tree2', $data);
        $this->load->view('footer/footer1');
...
//      $result=$this->tree_model->get_tree_data($id);
        $this->load->view('header/header2', $data1);
...
//        $genus_data = $this->session->userdata('kk');
    ...
    public function search_project_with_key_character()
    {
        ...
        $leaf_venation = $this->input->post('leaf venation');
...
//            if ($local_name != 'default') $this->db->where('tbl_local_name.local_name', $local_name);
            $this->db->like('local_name', $keyword);
            $this->db->where('tbl_common_character.species', $genus_demo);
