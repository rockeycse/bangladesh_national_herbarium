<div class="content-wrapper">
    <div class="container">
        ...
        <?php echo form_open('search/search_project'); ?>
        ...
        <?php echo form_close(); ?>
            ...
            <?php echo form_open('search/search_project_with_key_character'); ?>
            <section class="content">
                <div class="row">
                    <div class="col-md-10 col-lg-offset-1">
                        <div class="form-group col-sm-3">
...
<script type="text/javascript">
    function get_class_subject(family_name) {
        $.ajax({
            url: '<?php echo base_url();?>index.php/search/get_genus_by_family/' + family_name,
...
<script type="text/javascript">
    function get_class_subject_genus(genus_name) {
        $.ajax({
            url: '<?php echo base_url();?>index.php/search/get_species_by_genus/' + genus_name,
            success: function (response) {
                jQuery('#subject_selection_holder').html(response);
            }
        });
...
<script type="text/javascript">
    function get_class_subject_species(species_name) {
        $.ajax({
            url: '<?php echo base_url();?>index.php/search/get_local_by_species/' + species_name,
            success: function (response) {
                jQuery('#subject_selection_holder').html(response);
            }
        });
    ...
    $(this).ready(function () {
        $("#family_id").autocomplete({
            ...
            source: function (req, add) {
                ...
                $.ajax({
                    url: "<?php echo base_url(); ?>index.php/search/family_name_autocomplete",
                    dataType: 'json',
                    type: 'POST',
                    data: req,
    ...
    $(this).ready(function () {
        $("#genus_id").autocomplete({
            ...
            source: function (req, add) {
                console.log('Inside function source()');
                $.ajax({
                    url: "<?php echo base_url(); ?>index.php/search/genus_name_autocomplete",
                    dataType: 'json',
                    type: 'POST',
                    data: req,
                    success: function (data) {
    ...
    $(this).ready(function () {
        $("#species_id").autocomplete({
            ...
            source: function (req, add) {
                console.log('Inside function source()');
                $.ajax({
                    url: "<?php echo base_url(); ?>index.php/search/species_name_autocomplete",
                    dataType: 'json',
                    type: 'POST',
                    data: req,
                    success: function (data) {
    ...
    $(this).ready(function () {
        $("#local_name_id").autocomplete({
            ...
            source: function (req, add) {
                console.log('Inside function source()');
                $.ajax({
                    url: "<?php echo base_url(); ?>index.php/search/local_name_autocomplete",
                    dataType: 'json',
                    type: 'POST',
                    data: req,
                    success: function (data) {
