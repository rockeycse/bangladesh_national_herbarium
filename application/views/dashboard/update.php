<div class="content-wrapper">
    <div class="container">
        ...
        <?php echo form_open_multipart('manage_tree/update'); ?>
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="genus" name="genus"
                                       placeholder="Genus" value="<?php echo $common[0]['genus']; ?>" required>
                            </div>

                            <div class="form-group">

                                <input type="text" class="form-control" id="species" name="species"
                                       placeholder="Species" value="<?php echo $common[0]['species']; ?>" required>
                            </div>

                            <div class="form-group">

                                <input type="text" class="form-control" id="author" name="author"
                                       placeholder="Author" value="<?php echo $common[0]['author']; ?>">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="family_name" name="family_name"
                                       placeholder="Family name" value="<?php echo $common[0]['family_name']; ?>"
                                       required>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="synonyms" name="synonyms"
                                       placeholder="Synonyms" value="<?php echo $common[0]['synonyms']; ?>">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="english_name" name="english_name"
                                       placeholder="English Name" value="<?php echo $common[0]['english_name']; ?>">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="flowering_period" name="flowering_period"
                                       placeholder="Fruits & Flowering Period"
                                       value=" <?php echo $common[0]['flowering_period']; ?>" required>
                            </div>
                            <input type="hidden" name="id" value="<?php echo $common[0]['id']; ?>">
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <textarea rows="4" class="form-control" placeholder="Description"
                                          name="description"><?php echo $common[0]['description']; ?></textarea>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="habit" name="habit"
                                       placeholder="Habitat" value="<?php echo $common[0]['habit']; ?>">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="distribution" name="distribution"
                                       placeholder="Distribution" value="<?php echo $common[0]['distribution']; ?>">
                            </div>

                            <label>Uses</label>
                            <div class="form-group">

                                <textarea rows="4" class="form-control" placeholder="Uses."
                                          name="uses"><?php echo $common[0]['uses']; ?></textarea>
                        ...
                        <div class="box-body">
                            <table id="t01">
                                <tr>
                                    <td>
                                        <img
                                            src="<?php echo base_url(); ?>uploads/<?php echo $common[0]['photographs1']; ?>"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="photographs1_link"
                                                   name="photographs1_link"
                                                   value="<?php echo $common[0]['photographs1_link']; ?>"
                                    ...
                                    <td>
                                        ...
                                        <img
                                            src="<?php echo base_url(); ?>uploads/<?php echo $common[0]['photographs2']; ?>"
                                            width="200" height="200">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="photographs2_link"
                                                   name="photographs2_link"
                                                   value="<?php echo $common[0]['photographs2_link']; ?>"
                                                   placeholder="photographs2 link">
                                        </div>
                                    </td>
                                    <td>
                                        <img
                                            src="<?php echo base_url(); ?>uploads/<?php echo $common[0]['photographs3']; ?>"
                                            width="200" height="200">
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="photographs3_link"
                                                   name="photographs3_link"
                                                   value="<?php echo $common[0]['photographs3_link']; ?>"
                                ...
                                <tr>
                                    <td>
                                        <img
                                            src="<?php echo base_url(); ?>uploads/<?php echo $common[0]['photographs4']; ?>"
                                            width="200" height="200">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="photographs4_link"
                                                   name="photographs4_link"
                                                   value="<?php echo $common[0]['photographs4_link']; ?>"
                                    ...
                                    <td>
                                        ...
                                        <img
                                            src="<?php echo base_url(); ?>uploads/<?php echo $common[0]['photographs5']; ?>"
                                            width="200" height="200">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="photographs5_link"
                                                   name="photographs5_link"
                                                   value="<?php echo $common[0]['photographs5_link']; ?>"
                                    ...
                                    <td>
                                        ...
                                        <?php //echo $common[0]['photographs1']; ?><!--"-->
                                        <!--                                            width="80" height="80">-->
                                        <div class="form-group">
                                            <!--                                            <label for="photographs6">Photographs no 3</label>-->
                                            <!--                                            <input type="file" id="photographs3" name="photographs6">-->
                                        </div>
                                    </td>
                                </tr>
                            </table>
        ...
        <!--        </form>-->
        <?php echo form_close(); ?>
        <?php echo form_open_multipart('manage_tree/update_local_name'); ?>
        <div class="row">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="local_name1" name="local_name1"
                                   ...
                                   value="<?php echo !empty($key_data_local[0]['local_name']) ? $key_data_local[0]['local_name'] : "" ?>">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="local_name2" name="local_name2"
                                   ...
                                   value="<?php if (!empty($key_data_local[1]['local_name'])) echo $key_data_local[1]['local_name']; ?>">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="local_name3" name="local_name3"
                                   ...
                                   value="<?php echo !empty($key_data_local[2]['local_name']) ? $key_data_local[2]['local_name'] : "" ?>">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="local_name4" name="local_name4"
                                   ...
                                   value="<?php if (!empty($key_data_local[3]['local_name'])) echo $key_data_local[3]['local_name']; ?>">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="local_name5" name="local_name5"
                                   ...
                                   value="<?php if (!empty($key_data_local[4]['local_name'])) echo $key_data_local[4]['local_name']; ?>">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="local_name6" name="local_name6"
                                   ...
                                   value="<?php if (!empty($key_data_local[5]['local_name'])) echo $key_data_local[5]['local_name']; ?>">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="local_name7" name="local_name7"
                                   ...
                                   value="<?php if (!empty($key_data_local[6]['local_name'])) echo $key_data_local[6]['local_name']; ?>">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="local_name8" name="local_name8"
                                   ...
                                   value="<?php if (!empty($key_data_local[7]['local_name'])) echo $key_data_local[7]['local_name']; ?>">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="local_name9" name="local_name9"
                                   ...
                                   value="<?php if (!empty($key_data_local[8]['local_name'])) echo $key_data_local[8]['local_name']; ?>">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="local_name10" name="local_name10"
                                   ...
                                   value="<?php if (!empty($key_data_local[9]['local_name'])) echo $key_data_local[9]['local_name']; ?>">
                        </div>
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="local_name11" name="local_name11"
                                   ...
                                   value="<?php if (!empty($key_data_local[10]['local_name'])) echo $key_data_local[10]['local_name']; ?>">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="local_name12" name="local_name12"
                                   ...
                                   value="<?php if (!empty($key_data_local[10]['local_name'])) echo $key_data_local[11]['local_name']; ?>">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="local_name13" name="local_name13"
                                   ...
                                   value="<?php if (!empty($key_data_local[12]['local_name'])) echo $key_data_local[12]['local_name']; ?>">
                        </div>

                        <label>Local Name 14 </label>
                        <div class="form-group">

                            <input type="text" class="form-control" id="local_name14" name="local_name14"
                                   placeholder="Local Name 14"
                                   value="<?php if (!empty($key_data_local[13]['local_name'])) echo $key_data_local[13]['local_name']; ?>">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="local_name15" name="local_name15"
                                   ...
                                   value="<?php if (!empty($key_data_local[14]['local_name'])) echo $key_data_local[14]['local_name']; ?>">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="local_name16" name="local_name16"
                                   ...
                                   value="<?php if (!empty($key_data_local[15]['local_name'])) echo $key_data_local[15]['local_name']; ?>">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="local_name17" name="local_name17"
                                   ...
                                   value="<?php if (!empty($key_data_local[16]['local_name'])) echo $key_data_local[16]['local_name']; ?>">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="local_name18" name="local_name18"
                                   ...
                                   value="<?php if (!empty($key_data_local[17]['local_name'])) echo $key_data_local[17]['local_name']; ?>">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="local_name19" name="local_name19"
                                   ...
                                   value="<?php if (!empty($key_data_local[18]['local_name'])) echo $key_data_local[18]['local_name']; ?>">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="local_name20" name="local_name20"
                                   ...
                                   value="<?php if (!empty($key_data_local[19]['local_name'])) echo $key_data_local[19]['local_name']; ?>">
                        </div>
                        <input type="hidden" name="id" value="<?php echo $common[0]['id']; ?>">
                    </div>
                </div>
        ...
        <div class="col-sm-3 col-lg-offset-4">
            <button type="submit" class="btn btn-primary btn-block btn-flat">Update Local Name</button>
            <br>
