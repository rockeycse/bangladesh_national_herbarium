...
<div class="wrapper">
    ...
    <header class="main-header">
        <!-- Logo -->
        <a href="<?php echo base_url(); ?>index.php/dashboard2" class="logo">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu">
                ...
                <li class="active treeview">
                    <a href="<?php echo base_url(); ?>index.php/dashboard2"><i
                ...
                <li class="active treeview"><a href="<?php echo base_url(); ?>index.php/search2/tree_list"><i class="fa fa-tree"></i> List of Tree </a>
                </li>

                <li class="active treeview">
                    <a href="<?php echo base_url(); ?>index.php/search2"><i
